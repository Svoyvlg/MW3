...
## Примечание
- Этот репозиторий не содержит никакого кода TeknoMW3, он просто предоставляет поддержку и помощь англоговорящим пользователям.
- Если вы не знаете английский, вы можете использовать [DeepL](https://www.deepl.com/translator) в качестве переводчика с английского на язык X. Если вы знаете испанский, вы можете посетить [репозиторий SoyRA](https://github.com/SoyRA/TeknoMW3).
